...
class SurfaceGradientMaterial():
    ...
    def __init__(self, gradient_name):
        ...
        self.variants_and_gradients = {
            "flames": [
                (1.000, 0.909, 0.031, 1), (1.000, 0.808, 0.000, 1),
                (1.000, 0.604, 0.000, 1), (1.000, 0.352, 0.000, 1),
                (1.000, 0.000, 0.000, 1)
            ],
            "ocean": [
                (0.964, 0.976, 1.000, 1), (0.847, 0.867, 1.000, 1),
                (0.364, 0.533, 0.816, 1), (0.208, 0.216, 0.721, 1),
                (0.098, 0.157, 0.455, 1)
            ],
            "sunset": [
                (0.980, 0.757, 0.541, 1), (0.945, 0.506, 0.372, 1),
                (0.674, 0.345, 0.380, 1), (0.384, 0.207, 0.309, 1),
                (0.176, 0.157, 0.294, 1)
            ],
            "forest": [
                (0.643, 0.984, 0.651, 1), (0.290, 0.898, 0.290, 1),
                (0.188, 0.796, 0.000, 1), (0.059, 0.572, 0.000, 1),
                (0.000, 0.384, 0.012, 1)
            ]
        }
        pass
    ...
    def create_surface_material(self):
        ...
        self.create_gradient(
            elements, self.variants_and_gradients.get(self.gradient_name))
        ...
        material.node_tree.links.new(
            color_ramp.inputs["Fac"], separate_xyz.outputs["Z"])
        ...
        material.node_tree.links.new(
            separate_xyz.inputs["Vector"], texture_cord.outputs["Generated"])
        return material
